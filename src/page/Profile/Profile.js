  ...
  return (
    <div className={styles.container}>
      ...
      <Modal activeModal={modalActive} setActiveModal={setModalActive}>
        ...
        <div className="modal-msg-user-hide">
          <div className="modal-msg-user-box">
            <img className="modal-msg-user-avatar" src={avaURL + avatar} alt="logo"/>
        ...
        <div className="modal-msg">
          ...
          <div className="modal-msg-posts">
              <div className="modal-msg-posts-box">
                <img className="modal-msg-posts-avatar" src={userLogo} alt="logo"/>
                <div className="modal-msg-posts-nick">{nick}</div>
            </div>
          ...
          <div className="modal-msg-comments">
            <Input comment className="modal-msg-com"/>
